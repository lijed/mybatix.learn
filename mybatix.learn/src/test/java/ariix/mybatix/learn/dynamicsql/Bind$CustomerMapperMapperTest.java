 ...
 *
 */
public class Bind$CustomerMapperMapperTest extends TestCase {
	...
	@Test
	public void testDynamicSql$Bind() {
		...
		List<CustomerDomain> customers = customerMapper.findCustomersBy(searchCriteria);
